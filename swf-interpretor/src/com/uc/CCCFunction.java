...
public class CCCFunction {
	...
	private final AppDomain appDom = new AppDomain();
	...
	public CCCFunction() {
			...
			public Object call(Object receiver, Object[] params) {
				...
				if (!ptr.isCompatible(len))
					throw new IllegalStateException(
							"len should always be compatible with ptr");
		...
		interpretor = new Interpretor(appDom);
	}

	public String callCCC(int a, String b, int c) {
		String ret = (String) interpretor.callGlobalFunction(f, new Object[] {
				a, b, c });
		return ret;
	}
}
